...
from space_sdk.client.oauth2 import SpaceOauth2

SCOPE='**'

class SpaceAccessToken(BaseHTTPRequestHandler):
...
def run(server_class=HTTPServer, handler_class=SpaceAccessToken, addr="localhost", port=8001):
...
__pdoc__ = {}
__pdoc__['SpaceAccessToken'] = False
