...
def add_administrator(projects: Projects, projectId: str, profileId: str):
    """
        https://{company}.jetbrains.space/httpApiPlayground?resource=projects_xxx_administrators_members&endpoint=rest_create
    :param projects:
    :param projectId:
    :param profileId:
    :return:
...
def remove_administrator(projects: Projects, projectId: str, profileId: str):
    """
        https://{company}.jetbrains.space/httpApiPlayground?resource=projects_xxx_administrators_members&endpoint=rest_delete_xxx
    :param projects:
    :param projectId:
    :param profileId:
    :return:
